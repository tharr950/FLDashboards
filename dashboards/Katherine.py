...
def render_app(config):
    ...
    if page == "🏠 Home":
        ...
        try:
            _toggle_mismatch_df = load_buc_instruction_toggle_mismatch("Katherine Marino")
...
**Multiple tutors** is based on the last 30 days. When filtering to "Solo Tutor Only", only students where this tutor is their **only** tutor are shown.
    ...
    if page == "Test Prep & Exams":
        ...
        try:
            _report_path = "data/exam_reports/Katherine_Marino_exam_report.pdf"
...
**Tutors with no updates sent that week will appear with blank scores.**
    ...
    if page == "🚫 Restricted Status":
        ...
        try:
            ...
            restr_df = restr_df[restr_df["faculty_leader"] == "Katherine Marino"].copy()
        except Exception as e:
    ...
    if page == "📅 Meetings":
        ...
        try:
            ...
            mtg_df = mtg_df[mtg_df["faculty_leader"] == "Katherine Marino"].copy()
        except Exception as e:
