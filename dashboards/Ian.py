...
def render_app(config):
        ...
        with tab_detail:
            if view_grades_df.empty:
                ...
                st.download_button(
                    ...
                    data=output_g,
                    file_name="Grades_Detail_TeamPlamondon.xlsx",
        ...
        with tab1:
            ...
            if archive_df.empty:
                ...
                st.download_button(
                    ...
                    data=output,
                    file_name="Archivable_Students_TeamPlamondon.xlsx",
                    mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                )
        ...
        with tab2:
            ...
            if unsched_df.empty:
                ...
                st.download_button(
                    ...
                    data=output,
                    file_name="Unscheduled_Hours_TeamPlamondon.xlsx",
                    mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                )
    ...
    if page == "KPI Trends":
        ...
        if selected_tutor:
            ...
            ian_team = master_df[master_df["Faculty Leader"] == "Ian Plamondon"]["Full Name"].dropna()
            team_df  = monthly_df[monthly_df["Tutor Name"].isin(ian_team)].copy()
