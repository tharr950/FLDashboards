        ...
        with tab_detail:
            if view_grades_df.empty:
                ...
                st.download_button(
                    ...
                    data=output_g,
                    file_name="Grades_Detail_TeamDeGroot.xlsx",
        ...
        with tab1:
            ...
            if archive_df.empty:
                ...
                st.download_button(
                    ...
                    data=output,
                    file_name="Archivable_Students_TeamDeGroot.xlsx",
                    mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                )
        ...
        with tab2:
            ...
            if unsched_df.empty:
                ...
                st.download_button(
                    ...
                    data=output,
                    file_name="Unscheduled_Hours_TeamDeGroot.xlsx",
                    mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                )
