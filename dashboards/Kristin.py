    ...
    if page == "📹 Parent Update Videos":
        ...
        if not _vid_history.empty and "faculty leader" in _vid_history.columns:
            _all_video_df = _vid_history[
                (_vid_history["faculty leader"] == "Team Haase-Alvey") &
                (_vid_history["tutor"] != "Kristin Haase-Alvey")
            ].copy()
        else:
            _all_video_df = raw_video_df[
                (raw_video_df["faculty leader"] == "Team Haase-Alvey") &
                (raw_video_df["tutor"] != "Kristin Haase-Alvey")
            ].copy()
